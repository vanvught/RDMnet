...
etcpal_error_t rpt_send_request(RCConnection* conn, const EtcPalUuid* local_cid, const RptHeader* header,
                                const RdmBuffer* cmd);
etcpal_error_t rpt_send_status(RCConnection* conn, const EtcPalUuid* local_cid, const RptHeader* header,
                               const RptStatusMsg* status);
etcpal_error_t rpt_send_notification(RCConnection* conn, const EtcPalUuid* local_cid, const RptHeader* header,
                                     const RdmBuffer* cmd_arr, size_t cmd_arr_size);
