...
typedef struct RCClientConnection RCClientConnection;
...
typedef void (*RCConnectedCallback)(RCClientConnection* conn, const RCConnectedInfo* connect_info);

// An RDMnet connection attempt failed. failed_info contains more information about the connect
// failure event.
typedef void (*RCConnectFailedCallback)(RCClientConnection* conn, const RCConnectFailedInfo* failed_info);
...
typedef void (*RCDisconnectedCallback)(RCClientConnection* conn, const RCDisconnectedInfo* disconn_info);
...
typedef void (*RCMessageReceivedCallback)(RCClientConnection* conn, const RdmnetMessage* message);
...
typedef void (*RCDestroyedCallback)(RCClientConnection* conn);

// The set of callbacks which are called with notifications about RDMnet connections.
typedef struct RCClientConnectionCallbacks
{
...
typedef struct RCConnection
{
  /////////////////////////////////////////////////////////////////////////////
  // For external connections, fill this in before initialization.
...
typedef struct RCClientConnection
{
  /////////////////////////////////////////////////////////////////////////////
